...
public abstract class RuleRingSubstituents extends RuleRings {
	...
	private short flagValue = 0;
	private boolean flag_heterocyclyc = false;
	/**
	 * 
	 */
	...
	/**
	 * @param analyzeOnlyRingsWithFlagSet
	 *            The analyzeOnlyRingsWithFlagSet to set.
	 */

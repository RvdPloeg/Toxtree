 ...
 * 
 * @author Nina Jeliazkova <b>Modified</b> 2008-3-5
 */
public class AromaticityTest extends TestCase {
	...
	public void testDeduceBondOrders() throws Exception {
		...
		CDKAtomTypeMatcher matcher = CDKAtomTypeMatcher.getInstance(m
				.getBuilder());
		...
		for (int i = 0; i < m1.getBondCount(); i++) {
			...
			if (o.equals(Order.DOUBLE))
				double_bonds++;
			if (o.equals(Order.SINGLE))
				single_bonds++;

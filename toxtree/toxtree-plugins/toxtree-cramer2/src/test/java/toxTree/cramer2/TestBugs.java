...
/**
 * https://sourceforge.net/tracker/?func=detail&aid=3445043&group_id=152702&atid
 * =785126
 * 
 * @author nina
 * 
...
public class TestBugs extends AbstractTreeTest {
	...
	@Test
	public void test3488950_1() throws Exception {
	...
	@Test
	public void test3488950_2() throws Exception {
		IDecisionResult result = classify("Cc1cccc(C)c1O");
		Assert.assertEquals(3, result.getCategory().getID());
	}

	@Test
	public void test3488950_3() throws Exception {

		IDecisionResult result = classify("Cc1cc(O)ccc1C");
		Assert.assertEquals(3, result.getCategory().getID());
	...
	public void test3089699_40N() throws Exception {
		...
		Assert.assertEquals("1N,2N,3Y,4Y,40N,41N(7N,16N,17N,19Y,20Y,21N,44N,18N)", cr.explainRules(result, false)
				.toString());

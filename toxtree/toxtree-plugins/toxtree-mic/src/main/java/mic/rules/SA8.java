...
public class SA8 extends StructureAlert {
	...
	public SA8() {
		try {
			...
			b.append(";");
			b
					.append("!$([CX4H2]([F,Cl,Br,I])[CX4H2][N,S][CX4H2][CX4H2][F,Cl,Br,I])");
			 ...
			 * b.append("<li>tertiary halogens");b.append(
			 * "<li>primary aliphatic halocarbons adjoined to a sterically crowded atom"
			 * );
			 * 
			 * b.append("</ul>"); b.append("should be excluded.<br/>");
			 */
			b
					.append("Substances fired by Alerts <a href=\"#SA2\">SA2</a>,<a href=\"#SA4\">SA4</a>,<a href=\"#SA5\">SA5</a> and <a href=\"#SA20\">NA20</a> should be also excluded.");

...
public class PB30 extends StructureAlert {
    /**
	 * 
	 */
	...
	public PB30() {
        ...
        try {
        	  ...
        	  setID("PB30");
              setTitle("Nucleophilic substitution of organic acid azides");
              setExplanation("");
              
        	setContainsAllSubstructures(false);
            addSubstructure("PB30.1", "C(=O)N=[N+1]=[N-1]");
            addSubstructure("PB30.2", "S(=O)(=O)N=[N+1]=[N-1]");

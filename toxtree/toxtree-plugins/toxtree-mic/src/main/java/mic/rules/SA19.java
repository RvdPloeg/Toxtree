 ...
 * 
 */
public class SA19 extends SA18 {
	/**
     * 
     */
	...
	public SA19() {
		...
		examples[1] = "C=1C=CC2=NC3=CC=CC=C3(N=C2(C=1))"; // "NC1C=CC2=NC3=CC=CC=C3(N=C2(C1))";
															// "N=1C=3C=CC=CC=3(N=C2C=C(N)C=CC=12)";
	}
	...
	public String getImplementationDetails() {
		...
		b
				.append("<li>If the set of fused rings contains > 2 aromatic rings and > 1 heteroaromatic rings, the rule returns true.</ol>");
		return b.toString();
	}

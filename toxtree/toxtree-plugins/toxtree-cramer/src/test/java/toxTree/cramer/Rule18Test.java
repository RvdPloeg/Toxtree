 ...
 * 
 * @author Vedina <b>Modified</b> 2005-8-20
 */
public class Rule18Test extends AbstractRuleTest {
	...
	@Test
	public void testRuleA() throws Exception {
		Object[][] answer = {
				// vicinal diketone
				...
				{ "O(C)C(C=C)(OC)CCC", new Boolean(true) }, // not an acetal
															// RC(R)(OR)OR
				{ "O(C)C(OC)(C=CC)CC", new Boolean(false) }, // not a terminal
																// vinyl

		};
		QueryAtomContainer q = FunctionalGroups.vicinalDiKetone();
		for (int i = 0; i < 3; i++)
			assertEquals(FunctionalGroups.hasGroup(FunctionalGroups
					.createAtomContainer((String) answer[i][0], true), q),
	...
	public void testRuleB() throws Exception {
		...
		assertTrue(FunctionalGroups.hasGroup(FunctionalGroups
				.createAtomContainer((String) answer[0][0], true),
				FunctionalGroups.alcoholSecondaryAttachedToTerminalVinyl()));
		assertFalse(FunctionalGroups.hasGroup(FunctionalGroups
				.createAtomContainer((String) answer[1][0], true),
				FunctionalGroups.alcoholSecondaryAttachedToTerminalVinyl()));
		assertFalse(FunctionalGroups.hasGroup(FunctionalGroups
				.createAtomContainer((String) answer[2][0], true),
				FunctionalGroups.alcoholSecondaryAttachedToTerminalVinyl()));

		assertTrue(FunctionalGroups.hasGroup(FunctionalGroups
				.createAtomContainer((String) answer[3][0], true),
				FunctionalGroups
						.esterOfalcoholSecondaryAttachedToTerminalVinyl()));
		assertFalse(FunctionalGroups.hasGroup(FunctionalGroups
				.createAtomContainer((String) answer[4][0], true),
				FunctionalGroups
						.esterOfalcoholSecondaryAttachedToTerminalVinyl()));
		assertFalse(FunctionalGroups.hasGroup(FunctionalGroups
				.createAtomContainer((String) answer[5][0], true),
				FunctionalGroups
						.esterOfalcoholSecondaryAttachedToTerminalVinyl()));
	...
	public void testRuleC() throws Exception {
		...
		assertTrue(FunctionalGroups.isSubstance(FunctionalGroups
				.createAtomContainer((String) answer[0][0], true), q));
		assertFalse(FunctionalGroups.isSubstance(FunctionalGroups
				.createAtomContainer((String) answer[1][0], true), q));
		assertFalse(FunctionalGroups.isSubstance(FunctionalGroups
				.createAtomContainer((String) answer[2][0], true), q));

		q = FunctionalGroups.allylAlcoholAcetal();
		assertTrue(FunctionalGroups.hasGroup(FunctionalGroups
				.createAtomContainer((String) answer[3][0], true), q));
		assertFalse(FunctionalGroups.hasGroup(FunctionalGroups
				.createAtomContainer((String) answer[4][0], true), q));
		assertFalse(FunctionalGroups.hasGroup(FunctionalGroups
				.createAtomContainer((String) answer[5][0], true), q));

		q = FunctionalGroups.allylAlcoholEsterDerivative();
		assertTrue(FunctionalGroups.hasGroup(FunctionalGroups
				.createAtomContainer((String) answer[6][0], true), q));
		assertTrue(FunctionalGroups.hasGroup(FunctionalGroups
				.createAtomContainer((String) answer[7][0], true), q));
		IAtomContainer mol = FunctionalGroups.createAtomContainer(
				(String) answer[8][0], true);
		assertNotNull(mol);
	...
	public void testRuleD() throws Exception {
		...
		assertTrue(FunctionalGroups.isSubstance(FunctionalGroups
				.createAtomContainer((String) answer[0][0], true), a));
		assertFalse(FunctionalGroups.isSubstance(FunctionalGroups
				.createAtomContainer((String) answer[1][0], true), a));
		assertFalse(FunctionalGroups.isSubstance(FunctionalGroups
				.createAtomContainer((String) answer[2][0], true), a));

		a = FunctionalGroups.allylSulphide();
		assertTrue(FunctionalGroups.isSubstance(FunctionalGroups
				.createAtomContainer((String) answer[3][0], true), a));
		assertFalse(FunctionalGroups.isSubstance(FunctionalGroups
				.createAtomContainer((String) answer[4][0], true), a));
		assertFalse(FunctionalGroups.isSubstance(FunctionalGroups
				.createAtomContainer((String) answer[5][0], true), a));

		a = FunctionalGroups.allylThioester();
		assertTrue(FunctionalGroups.isSubstance(FunctionalGroups
				.createAtomContainer((String) answer[6][0], true), a));
		assertFalse(FunctionalGroups.isSubstance(FunctionalGroups
				.createAtomContainer((String) answer[7][0], true), a));
		assertFalse(FunctionalGroups.isSubstance(FunctionalGroups
				.createAtomContainer((String) answer[8][0], true), a));

		a = FunctionalGroups.allylAmine();
		assertTrue(FunctionalGroups.isSubstance(FunctionalGroups
				.createAtomContainer((String) answer[9][0], true), a));
		assertFalse(FunctionalGroups.isSubstance(FunctionalGroups
				.createAtomContainer((String) answer[10][0], true), a));
		assertFalse(FunctionalGroups.isSubstance(FunctionalGroups
				.createAtomContainer((String) answer[11][0], true), a));
		ruleTest(answer);
	}
	...
	@Test
	public void testRuleI() throws Exception {
		Object[][] answer = {
				// sterically hindered
	...
	/*
	 * public void classify(Object[][] answer) throws Exception { IDecisionRule
	 * rule18 = new RuleKetoneAlcoholEtc(); for (int i = 0; i < answer.length;
	 * i++) { IMolecule mol = (IMolecule)
	 * FunctionalGroups.createAtomContainer((String)answer[i][0]); if (mol !=
	 * null) { MolAnalyser.analyse(mol); Boolean b = (Boolean) answer[i][1];
	...
	public void test() throws Exception {
		Object[][] answer = { { "CC(OC)(OC)C=C", new Boolean(true) }, // 18Y

...
public class CategoryPositiveAlertGenotoxic extends MutantCategory {
	...
	public CategoryPositiveAlertGenotoxic() {
		super("Structural Alert for genotoxic carcinogenicity",1,2);

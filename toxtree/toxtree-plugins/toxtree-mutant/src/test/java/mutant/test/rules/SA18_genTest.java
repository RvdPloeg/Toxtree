...
public class SA18_genTest extends TestMutantRules {
	String[] smiles = { "c1ccc2c(c1)c1c(C2)cccc1NC(C)=O", "c1cc2ccc3c4c2c(c1)ccc4ccc3",
			"c1ccc2c(c1)Cc1c2ccc(c1)NC(=O)C", "c1c2ccc3cccc4ccc(c5c1cccc5)c2c34",
			"C1c2c3c(C1)c(ccc3cc1c2ccc2c1cccc2)C", "c1ccc2c(c1)c1c(C2)cc(cc1)NC(=O)C(F)(F)F",
			"C1c2c(c3c1c(ccc3)N(C(C)=O)C(C)=O)cccc2", "c1c2ccc3c(c2cc2c1c1c(cc2)cccc1)cccc3",
			"C1c2c(c3c1cc(cc3)N(C(C)=O)O)cccc2", "c1ccc2c(c1)C(c1c3c2ccc2c3c(cc1)c1c(C2=O)cccc1)=O",
			"CC(=O)Nc1c2Cc3ccccc3c2ccc1", "Cc1c2ccccc2c(c2ccc3c(c12)cccc3)C" };
	...
	public void testTrue() throws Exception {
		// IAtomContainer c =
		// FunctionalGroups.createAtomContainer("CC(=O)NC=1C=CC=C2C3=CC=CC=C3(CC=12)",true);
	...
	public void testIndene() throws Exception {
		assertTrue(verifyRule(ruleToTest, "C=1C=CC=2CCCC=2(C=1)"));

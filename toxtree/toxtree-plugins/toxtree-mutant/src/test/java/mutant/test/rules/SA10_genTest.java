...
public class SA10_genTest extends TestMutantRules {
	@Override
	...
	public void testException() throws Exception {
		...
		/**
		 * The tree smarts below gives NullPointerException when the queryBond
		 * is LogicalOperatorBond, because for some reason queryBond.getAtom(0)
		 * and getAtom(1) return null java.lang.NullPointerException at
		 * org.openscience
		 * .cdk.isomorphism.UniversalIsomorphismTester.nodeConstructor
		 * (UniversalIsomorphismTester.java:697) at
		 * org.openscience.cdk.isomorphism
		 * .UniversalIsomorphismTester.buildRGraph
		 * (UniversalIsomorphismTester.java:385) at
		 * org.openscience.cdk.isomorphism
		 * .UniversalIsomorphismTester.search(UniversalIsomorphismTester
		 * .java:414) at
		 * org.openscience.cdk.isomorphism.UniversalIsomorphismTester
		 * .getSubgraphMaps(UniversalIsomorphismTester.java:228) at
		 * org.openscience
		...
		/**
		 * The common feature of the three SMARTS is a logical operator between
		 * bonds
		 */
	}
}

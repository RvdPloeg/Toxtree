...
public class SA18_genTest extends TestAmesMutagenicityRules {
	String[] smiles = { "c1ccc2c(c1)c1c(C2)cccc1NC(C)=O",
			"c1cc2ccc3c4c2c(c1)ccc4ccc3", "c1ccc2c(c1)Cc1c2ccc(c1)NC(=O)C",
	...
	public void testTrue() throws Exception {
		...
		IAtomContainer c = FunctionalGroups.createAtomContainer(
				"C=1C=C2C=CC3=CC=CC4=CC=C(C=1)C2=C34", true);
	...
	public void test3() throws Exception {
		IAtomContainer c = FunctionalGroups.createAtomContainer(
				"c1(Cl)cc2c3cc(Cl)c(Cl)cc3c2cc1Cl", true);
		MolAnalyser.analyse(c);
		assertTrue(ruleToTest.verifyRule(c));

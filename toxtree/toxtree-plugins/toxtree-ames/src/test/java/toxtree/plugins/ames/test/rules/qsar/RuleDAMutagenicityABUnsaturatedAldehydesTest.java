...
public class RuleDAMutagenicityABUnsaturatedAldehydesTest extends LDARuleTest {

	public LinearDiscriminantRule createRuleToTest() throws Exception {
		return new RuleDAMutagenicityABUnsaturatedAldehydes();
	}
	public void testRuleDAMutagenicityABUnsaturatedAldehydes() {
		try {
			...
			assertTrue(ruleToTest.verifyRule(acrolein));
	...
	public void testDescriptorMRImplemented() throws Exception {
		List<IMolecularDescriptor> d = ruleToTest.getModel().getDescriptors();
		assertNotNull(d);
		assertNotNull(d.get(0));
	}
	public void testDescriptorLogPImplemented()  throws Exception{
		List<IMolecularDescriptor> d = ruleToTest.getModel().getDescriptors();
		assertNotNull(d);

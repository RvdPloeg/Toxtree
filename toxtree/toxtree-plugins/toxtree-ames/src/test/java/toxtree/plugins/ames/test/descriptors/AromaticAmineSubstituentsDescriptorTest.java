...
public class AromaticAmineSubstituentsDescriptorTest {
	...
	public void test() throws Exception {
		...
		CDKHydrogenAdder.getInstance(a.getBuilder()).addImplicitHydrogens(a);
	...
	*/
	...
	public void testOrder_Ammine39() throws Exception {
		Object[][] smiles = new Object[][] {
				...
				{ "Nc2ccc3c1ccccc1n([H])c3c2", "MR2", new Double(0.1), "MR3",
						new Double(0.54), "MR6", new Double(0.1) },
				{ "[NH]1C3=C(C2=CC=CC=C12)C=CC(=C3)N", "MR2", new Double(0.1),
	...
	public void testOrder_Ammine82() throws Exception {
		Object[][] smiles = new Object[][] { {
				"[NH]1C3=C(C2=CC=CC=C12)C(=CC=C3)N", "MR2", new Double(0.56),
				"MR3", new Double(0.54), "MR6", new Double(0.1) }, };
		amineGroupSubstituent(smiles);
	}

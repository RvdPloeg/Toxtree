...
public class SA13_gen extends StructureAlertCDK {
    /**
     * 
     */
    ...
    public SA13_gen() {
        ...
        try {
        	...
        	/**
        	 * + is not working in Joelib SMARTS implementation , for some reason
        	 */
        	//[#1,!#8]~[N;$([N!X4])]([#1,!#8])!@;-[N;$([N!X4])]~[#1,!#8]
        	//addSubstructure("Hydrazine", "[N;$([N!X4])]([#1,!#8])([#1,!#8])!@;-[N;$([N!X4])]~[#1,!#8]");

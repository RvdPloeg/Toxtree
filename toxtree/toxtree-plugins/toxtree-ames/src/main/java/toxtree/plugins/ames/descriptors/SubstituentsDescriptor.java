...
public abstract class SubstituentsDescriptor implements IMolecularDescriptor {
	protected static transient Logger logger = Logger
			.getLogger(SubstituentsDescriptor.class.getName());
	...
	public DescriptorValue calculate(IAtomContainer arg0) {
		try {
			Hashtable<String, IAtomContainerSet> substituents = extractor
					.extractSubstituents(arg0);
	...
	public abstract String select(
			Hashtable<String, IAtomContainerSet> substituents)
			throws CDKException;

	public abstract DescriptorValue calculate(IAtomContainerSet substituents,
			String mark) throws CDKException;
	...
	public Object getParameterType(String arg0) {
		...
		else if (paramNames[1].equals(arg0))
			return new String[] {};
		else
			return null;
	}
